package mdaros.training.lagom.lagomtraining.api
...
object LagomtrainingService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-training service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomtrainingService.
  */
trait LagomtrainingService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("lagom-training")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomtrainingService.TOPIC_NAME, greetingsTopic _)
